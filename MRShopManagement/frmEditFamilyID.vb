...
Public Class frmEditFamilyID
    ...
    Private Sub frmEditFamilyID_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmEditFamilyID_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
